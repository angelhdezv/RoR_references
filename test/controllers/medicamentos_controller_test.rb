...
class MedicamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicamento" do
    assert_difference('Medicamento.count') do
      post medicamentos_url, params: { medicamento: { Nombre: @medicamento.Nombre, gramaje: @medicamento.gramaje, laboratorio: @medicamento.laboratorio } }
    end
  ...
  test "should update medicamento" do
    patch medicamento_url(@medicamento), params: { medicamento: { Nombre: @medicamento.Nombre, gramaje: @medicamento.gramaje, laboratorio: @medicamento.laboratorio } }
